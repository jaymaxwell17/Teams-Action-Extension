...
function createCardCommand(context, action) {
    ...
    switch(data.title){
        case 'eedition':
            edition = "Purchase the Enterprise Edition - $99.99";
            break;
        case 'pedition':
            edition = "Purchase the Profesional Edition - $49.99";
            break;
        case 'spackage':
            edition = "Purchase the Starter Package - $29.99"
            break;
    }

    const heroCard = CardFactory.heroCard(edition, data.text);
